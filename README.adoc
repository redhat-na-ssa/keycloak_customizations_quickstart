...
. Exploration of Broker Federation using RH-SSO and Github
...
RHSSO_URL=https://$RHSSO_HOST/auth
...
-----
$ echo -en "\n$(
     oc get secret credential-rhsso -o json -n rhi-idm \
