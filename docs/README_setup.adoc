...
+
Doing so will ensure that there are not browser cookie related conflicts between the SSO realm admin and the user logged into the SSO account console.

. Navigate to the SSO accoountconsole of your realm :
+
-----
